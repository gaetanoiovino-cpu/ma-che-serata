...
class Flir2nightForum {
    ...
    loadMockData() {
        ...
        this.posts = [
            {
                id: 1,
                title: "🔥 Serata INCREDIBILE al Duomo Bar ieri sera!",
                content: "Ragazzi non ci credo ancora! Ieri sera al Duomo Bar è stata una delle serate più belle della mia vita. La playlist era perfetta, i cocktail buonissimi e ho conosciuto persone fantastiche! Qualcuno c'era? 🍸✨",
                author: {
                ...
                comments: 8,
                views: 156,
                tags: ["duomo", "cocktail", "milano", "nightlife"],
                isLiked: false,
                isSaved: false,
                images: ["https://images.unsplash.com/photo-1566737236500-c8ac43014a8e?w=400&h=300&fit=crop"]
            },
            {
                id: 2,
                title: "💃 Cerco gruppo per sabato sera - Corso Buenos Aires",
                content: "Ciao ragazze! Sabato sera vorrei andare in zona Corso Buenos Aires ma le mie amiche non possono. Qualcuna si vuole aggregare? Età 22-28, aperitivo + serata. DM me! 💕",
                author: {
                    username: "Sofia_22",
                    avatar: "💕",
                    reputation: 89,
                ...
                comments: 15,
                views: 89,
                tags: ["meetup", "sabato", "buenos-aires", "aperitivo"],
                isLiked: true,
                isSaved: false
            },
            {
                id: 3,
                title: "🎵 Playlist perfetta per pre-serata - I miei TOP 20",
                content: "Ho creato la playlist PERFETTA per il pre-serata! Mix di house, pop e qualche classico. Link in bio, fatemi sapere cosa ne pensate! Suggerimenti per nuove canzoni? 🎧",
                author: {
                ...
                comments: 12,
                views: 201,
                tags: ["playlist", "house", "pop", "pre-serata"],
                isLiked: false,
                isSaved: true
            },
            {
                id: 4,
                title: "⭐ REVIEW: Terrazza Aperol - 4.5/5 stelle",
                content: "Finalmente sono riuscita ad andare alla famosa Terrazza Aperol! Vista mozzafiato, cocktail buoni ma prezzi alti. Perfetto per occasioni speciali. Prenotate in anticipo! 🥂",
                author: {
                    username: "ReviewQueen_MI",
                    avatar: "👑",
                    reputation: 678,
                    badge: "Review Master"
                },
                ...
                comments: 6,
                views: 134,
                tags: ["aperol", "terrazza", "review", "cocktail"],
                isLiked: false,
                isSaved: false
            },
            {
                id: 5,
                title: "👗 OUTFIT CHECK: cosa mettere per una serata elegante?",
                content: "Help! Sabato ho un evento elegante ma non so cosa mettere. Dress code 'smart casual' ma voglio essere perfetta. Idee? Budget max 200€. Grazie bellezze! 💅",
                author: {
                ...
                comments: 23,
                views: 178,
                tags: ["outfit", "elegante", "smart-casual", "help"],
                isLiked: true,
                isSaved: true
            },
            {
                id: 6,
                title: "💰 DEAL ALERT: Lista ridotta per Plastic venerdì!",
                content: "Ragazzi ho 3 posti lista ridotta per il Plastic venerdì sera! House music + international DJs. Chi è interessato mi scriva subito! First come first served 🔥",
                author: {
                ...
                comments: 31,
                views: 267,
                tags: ["plastic", "lista", "ridotta", "house"],
                isLiked: false,
                isSaved: false,
                isPinned: true
            }
